...
function updateManagerImage(input) {
  ...
  reader.addEventListener("load", () => {
    ...
    row.querySelector('[data-manager-field="image"]').value = reader.result;
    row.querySelector(".manager-product-heading img").src = reader.result;
  });
